...
namespace Examen3.Controllers
{
    ...
    public class ComprasController : ControllerBase
    {
        ...
        public ComprasController(Examen3Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Compras>> PostCompras(Compras compras)
        {
            ...
            return CreatedAtAction("GetCompras", new { id = compras.Codigo }, compras);
        }
        ...
        {
            return _context.Compras.Any(e => e.Codigo == id);
        }
    }
}
